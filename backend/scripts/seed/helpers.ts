import { CourseSeed, PracticalSeed } from "./types";
 ...
 */
export function buildTopicContent(courseSlug: "html" | "css", moduleTitle: string, topicTitle: string): string {
...
export function buildCodeExampleFor(courseSlug: "html" | "css", topicTitle: string): { label: string; html: string; css: string; js: string } {
  if (courseSlug === "html") {
    return {
...
export function buildPracticalInstructions(courseSlug: "html" | "css", moduleTitle: string, practical: PracticalSeed): string {
  const subject = courseSlug === "html" ? "HTML" : "CSS";
  return [
...
export function buildStarterCode(courseSlug: "html" | "css", practical: PracticalSeed) {
  if (courseSlug === "html") {
    return {
...
export function allCoursesSlugs(courses: CourseSeed[]): string[] {
